...
<?php
$options_path = dirname(__FILE__) . "/squible_options.php";
$stylesheet_path = dirname(__FILE__) . "/custom.css";
if ( !file_exists($options_path) ) {
	exit("<p style=\"font-family: arial;\">You seem to be missing <b>squible_options.php</b>. If this is a fresh install, ensure you've renamed <b>squible_options-sample.php</b> after configuration.</p>");
} elseif ( !file_exists($stylesheet_path) ) {
	exit("<p style=\"font-family: arial;\">You seem to be missing <b>custom.css</b>. If this is a fresh install, ensure you've renamed <b>custom-sample.css</b> after configuration.</p>");
}
?>
...
<head profile="http://gmpg.org/xfn/11">
	...
	<link rel="stylesheet" type="text/css" media="screen" href="<?php bloginfo('stylesheet_directory'); ?>/style.css" />
        ...
        <script type="text/javascript"><?php include("livesearch.js.php"); ?></script>
...
<div id="top">
<div id="themenu">
<ul class="menu"><li class="<?if (((is_home()) && !(is_paged())) or (is_archive()) or (is_single()) or (is_paged()) or (is_search())) { ?>current_page_item<?php } ?>"><a href="<?php echo get_settings('home'); ?>"><?php _e('Blog', 'squible'); ?></a></li>
