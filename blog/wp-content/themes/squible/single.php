...
<table cellpadding="0" cellspacing="0"><tr><td valign="top" style="width: 140px; padding-left: 25px;">
        ...
        <div class="tooltitle"><?php _e('Related Tags', 'squible'); ?></div>
        <p style="margin-top: -2px; margin-bottom: 4px;" class="post-footer"><em>
	<?php 
	...
	?>
        ...
        <a href="<?php the_permalink() ?>#postcomment" rel="bookmark"><?php _e('Post comment', 'squible'); ?></a><br />
        <?php edit_post_link(__('Edit This Post', 'squible')); ?><br />
        </em></p>
	</td><td valign="top" style="padding-left: 20px; padding-right: 20px;">
        <div class="tooltitle"><?php _e('Trackback', 'squible'); ?></div>
        <p style="margin-top: -2px; margin-bottom: 4px;" class="post-footer"><em>
        <a href="<?php the_permalink() ?>trackback" rel="bookmark"><?php _e('Trackback', 'squible'); ?> <abbr title="Uniform Resource Identifier">URI</abbr></a>
        </em></p>
</td>
</tr><tr>
<td valign="top" style="padding-left: 25px;" colspan="2">
		...
		<form action="<?php $_SERVER['PHP_SELF']; ?>#extras" method="post">
  		...
  		<p><input type="text" name="cat_name" value="" style="font-size: 88%" /> <input style="font-size: 88%" type="submit" value="Add"><br /><font color="#000000"><?php _e('Add Tags:', 'squible'); ?></font> <?php _e('separate <br />multiple tags with commas</p>', 'squible'); ?>
  		</form>

		<?php if ($deleted) { ?>
		<br /><?php _e('Tag deleted, refresh list:', 'squible'); ?>
		...
		<br /><a href="<?php bloginfo('url'); ?>/wp-admin"><?php _e('Logged in', 'squible'); ?></a> <?php _e('users can add tags', 'squible'); ?>
		<br /><?php _e('Create an account', 'squible'); ?> <a href="<?php bloginfo('url'); ?>/wp-register.php"><?php _e('here', 'squible'); ?></a>
		<?php } ?>
        	<?php } ?>
		</em></p>
</td>
<td valign="bottom" style="text-align: right; padding-top: 10px; padding-left: 20px; padding-right: 20px;" colspan="3"><p class="post-footer"><em><?php _e('Search', 'squible'); ?> <?php bloginfo('name'); ?></em></p><?php include (TEMPLATEPATH . '/searchform.php'); ?></td></tr></table>
